  ...
  <div className="bg-white rounded-xl p-10 w-full max-w-md space-y-8 shadow-sm border border-gray-100">
    ...
    {showForget ? (
      ...
      <>
        ...
        <button
          type="button"
          className="w-full bg-white border border-gray-300 text-gray-700 font-medium py-2.5 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
