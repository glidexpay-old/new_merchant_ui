...
import { fetchSeamlessTrxn } from '@/app/redux/slices/pgTrxnSlice';
...
const TransactionsPage = () => {
  ...
  useEffect(() => {
    if (filters) {
      dispatch(fetchSeamlessTrxn(filters));
    }
  }, [dispatch, filters]);
  ...
  return (
    ...
    <div className="main-container mx-auto py-8 px-4">
      <h1 className='h1-text'>No-Seamless Transaction</h1>
